 ...
 *
 *  Lýsing  : Klasi sem útfærir birtingu Eitursnáks í notendaviðmóti.
 *
 *
 *****************************************************************************/
...
public class EiturSnakur extends Rectangle {
    ...
    /**
     * Smiður fyrir Eitursnák. Keyrir lesaEiturSnakur aðgerðina.
     */
    public EiturSnakur() {
        lesaEiturSnakur();
    }
    ...
    /**
     * Tengir eitursnákinn við útlit úr fxml skrá.
     */
    public void lesaEiturSnakur() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("eiturSnakur-view.fxml"));
    ...
    /**
     *  Færir eitursnákinn áfram á þeirri stefnu sem hann er á.
     */
    public void afram() {
